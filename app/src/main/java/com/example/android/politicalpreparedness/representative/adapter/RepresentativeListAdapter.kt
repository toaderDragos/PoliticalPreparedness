...
class RepresentativeListAdapter: ListAdapter<Representative, RepresentativeListAdapter.RepresentativeViewHolder>(RepresentativeDiffCallback){
    ...
    class RepresentativeViewHolder(val binding: RepresentativeItemBinding): RecyclerView.ViewHolder(binding.root) {
        ...
        fun bind(repItem: Representative) {
            binding.representative = repItem

            // Shows social links using below helper methods
            repItem.official.channels?.let { showSocialLinks(it) }

            // Shows www link using below helper methods
            repItem.official.urls?.let { showWWWLinks(it) }
